...
const supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlhdCI6MTYyODYxMDMzMCwiZXhwIjoxOTQ0MTg2MzMwfQ.Uxy2KiZ1meiAovuckfofcW8igoXcHcE9SETrRR6BUsY"
...
async function searchApp(query) {
    ...
    const results = apps.filter(app => app.name.toLowerCase().includes(query) || app.keywords.includes(query))
    console.log(results);
    return results
}
